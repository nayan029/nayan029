        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <div class="card-body">
                        <form role="form" id="main_form" method="POST" action="<?php echo URL::to('/') ?>/admin/document-deatils/{{$detailsData->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$detailsData->title}}" maxlength="30" class="form-control" id="title" name="title" aria-describedby="nameHelp" placeholder="Enter First Title">
                                ...
                                <div class="col-sm-12" style="display: none;" id="hidedesc">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control description" id="description" name="description" aria-describedby="nameHelp" placeholder="User Description">{!!$detailsData->description!!}</textarea>
...
<script>
    ...
    // ajax hide show
    getsubcategory('{{$detailsData->type}}');
