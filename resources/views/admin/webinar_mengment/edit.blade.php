...
<div class="content-wrapper" style="min-height: 40.0312px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small>Webinar Edit</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6 mt-2">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo URL::to('/') ?>/admin/home">Home</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo URL::to('/') ?>/admin/webinar">Manage Webinar</a></li>
                        <li class="breadcrumb-item">Webinar Edit</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <div class="card-body">
                        <form role="form" id="main_form" method="POST" action="<?php echo URL::to('/') ?>/admin/webinar/{{$data->id}}" enctype="multipart/form-data">
                			@method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFirstName">Webinar Title</label><span style="color: red;">*</span>
                                        <input type="text" maxlength="250" class="form-control" value="{{$data->webinar_title}}" id="title" name="title" aria-describedby="nameHelp" placeholder="Enter First Title">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <label for="exampleInputEmail">Webinar Image</label>
                                    ...
                                    <?php
                                            ...
                                            ?>
                                                <img style="border: 1px solid #ccc;" width="58px" height="58px" src="<?php echo URL::to('/'); ?>/uploads/webinar/{{$data->webinar_image}}" class="site-stg-img site-stg-img2 sr-image" id="blah" />
                                            <?php } else {
                                            ?>
                                                <br>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a href="<?php echo URL::to('/') ?>/admin/webinar"><button type="button" class="sa-btn-close p-2 float-right">Close</button></a>
