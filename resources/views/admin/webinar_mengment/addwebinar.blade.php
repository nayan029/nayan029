...
<div class="content-wrapper" style="min-height: 40.0312px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small>Admin Webinar</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6 mt-2">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">Admin Webinar</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <div class="card-body">
                        <form role="form" id="main_form" method="POST" action="<?php echo URL::to('/') ?>/admin/webinar" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-4">
                                    <!-- text input -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail">Webinar Image</label><span style="color: red;">*</span>
...
<script>
    ...
    $('#main_form').submit(function(e) {
        ...
        if (title.trim() == '') {
            $('#title_error').html("Please enter Webinar title");
            cnt = 1;
            f++;
            if (f == 1) {
                $('#title').focus();
