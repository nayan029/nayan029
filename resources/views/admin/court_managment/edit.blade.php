  ...
  <div class="modal-content">
      ...
      <div class="container">
          <form id="main_id1" method="POST" action="<?php echo URL::to('/') ?>/admin/court-managment/{{$data->id}}">
              @method('PUT')
              @csrf
              <div class="form-group">
                  <div class="col-sm-12">
                      <label for="exampleInputEmail1">Court Name</label><span style="color: red;">*</span>
                      <input type="text" maxlength="20" class="form-control" id="name1" value="{{$data->name}}" name="name" aria-describedby="emailHelp" placeholder="Enter name">
  ...
  <script>
      ...
      function checkvalidation() {
          ...
          $.ajax({
              url: "<?php echo URL::to('/'); ?>/admin/getexitcategoryedit",
              type: "POST",
              data: {
                  name: name,
                  id: id,
