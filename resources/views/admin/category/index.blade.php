            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form-inline mb-3" method="GET" action="<?php echo URL::to('/') ?>/admin/manageCategory">

                                <div class="form-group mr-2">
                                    <input type="text" maxlength="20" class="form-control w-180px" value="{{$name}}" id="" name="name" placeholder="Name">
                                </div>  
                                <button type="submit" class="btn btn-primary ml-2">Filter</button>
                                <a href="<?php echo URL::to('/'); ?>/admin/manageCategory"><button type="button" class="btn btn-dark ml-2">Reset</button></a>
                            </form>
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="container">
                                            <form id="main_id" method="POST" action="<?php echo URL::to('/') ?>/admin/manageCategory">
                                                @csrf
