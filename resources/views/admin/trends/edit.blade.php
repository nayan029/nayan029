...
<div class="content-wrapper" style="min-height: 40.0312px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small>Trends Edit</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6 mt-2">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">Trends Edit</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <div class="card-body">
                        <form role="form" id="main_form" method="POST" action="<?php echo URL::to('/') ?>/admin/trends/{{$data->id}}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="trends" name="trends">
                                            ...
                                            <option <?php if ($data->trend_name ) {
                                                        echo "selected";
                                                    } ?> value="{{$data->trend_name}}">{{$data->trend_name}}</option>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="250" class="form-control" id="title" name="title" value="{{$data->trend_title}}" aria-describedby="nameHelp" placeholder="Enter First Title">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        if ($data->trend_image) {
                                        ?>
                                            <img style="border: 1px solid #ccc;" width="58px" height="58px" src="<?php echo URL::to('/'); ?>/uploads/trends/{{$data->trend_image}}" class="site-stg-img site-stg-img2 sr-image" id="blah" />
                                        <?php } else {
                                        ?>
                                            <br>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="250" value="{{$data->short_description}}" class="form-control" id="short_description" name="short_description" aria-describedby="numberHelp" placeholder="Enter Short Description">
