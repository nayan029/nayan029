...
<div class="content-wrapper" style="min-height: 40.0312px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small>Blog Add</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6 mt-2">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">Blog Add</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <div class="card-body">
                        <form role="form" id="main_form" method="POST" action="<?php echo URL::to('/') ?>/admin/Blog" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-4">
                                    <!-- text input -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail">Blog Image</label><span style="color: red;">*</span>
...
<script>
    ...
    $('#main_form').submit(function(e) {
        ...
        if (image.trim() == '') {
            $('#image_error').html("Please select Picture");
            cnt = 1;
        }
        if (image) {
        ...
        if (description.trim() == '') {
            $('#description_error').html("Please enter descripjljtion");
            cnt = 1;
            f++;
            if (f == 1) {
                $('#description').focus();
