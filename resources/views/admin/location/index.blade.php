...
<div class="content-wrapper" style="min-height: 40.0312px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><small>Location Management</small></h1>
                </div><!-- /.col -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form-inline mb-3" method="GET" action="<?php echo URL::to('/') ?>/admin/manage-location">

                                <div class="form-group mr-2">
                                    <input type="text" maxlength="20" class="form-control w-180px" value="{{$name}}" id="" name="name" placeholder="Name">
                                </div>  
                                <button type="submit" class="btn btn-primary ml-2">Filter</button>
                                <a href="<?php echo URL::to('/'); ?>/admin/manage-location"><button type="button" class="btn btn-dark ml-2">Reset</button></a>
                            </form>
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="container">
                                            <form id="main_id" method="POST" action="<?php echo URL::to('/') ?>/admin/manage-location">
                                                @csrf
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <label for="exampleInputEmail1">Location</label><span style="color: red;">*</span>
                                                        <input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Enter location">
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    // $i = 1;
                                    $i = ($locationlist->currentpage()-1)* $locationlist->perpage() + 1;
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    {{ $locationlist->appends(request()->except('page'))->links("pagination::bootstrap-4") }}
...
<script>
    $(document).ready(function () {
        ...
        $('#manage_location').addClass('active mm-active');
    });
</script>
...
<script>
    function functionedit(id) {
        $.ajax({
            url: "<?php echo URL::to('/'); ?>/admin/manage-location/" + id + "/edit",
            type: "GET",
    ...
    function openPopup(id) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: "<?php echo URL::to('/'); ?>/admin/manage-location/" + id,
                    type: "DELETE",
                    data: {
                        id: id,
...
<script>
    ...
    function checkvalidation() {
        var name = $('#name').val();
        $.ajax({
            url: "<?php echo URL::to('/'); ?>/admin/getexitlocation",
            type: "POST",
            data: {
                name: name,
                _token: "<?php echo csrf_token(); ?>"
