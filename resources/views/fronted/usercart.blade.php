    ...
    <div class="col-md-12 pl-0 pr-0 sa-overflow">
        <table class="table table-bordered sr-t-bordered sa-font-acctable">
            ...
            <tr>
                ...
                <td class="sr-p-white sr-b-right text-white">@if(isset($data->type) && $data->type == '2'){{"Fees(By per date)"}}@elseif(isset($data->type) && $data->type == '3'){{"Legal Representation"}}@endif
