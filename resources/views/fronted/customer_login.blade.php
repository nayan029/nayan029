				...
				<div class="col-md-6 col2">
					<div class="top">
						<div class="inner">
							...
							<div class="form">
								<form method="POST" action="<?php echo URL::to('/'); ?>/customer/login" id="main_id">
									@csrf
								    ...
								    <div class="form-group mb-3 text-right">
								    	<a href="<?php echo URL::to('/')?>/customer/forgot-password" class="forgot-password">Forgot password?</a>
								    </div>
