        ...
        <div class="row">
          <div class="col-md-7 ">
            ...
            <?php foreach ($advicecategory as $data) {
             ?> 
              <li><a href="<?php echo URL::to('/'); ?>/indian-kanoon/<?php echo strtolower($data->slug);?>-legal-advice"><i class="fa fa-arrow-right"></i> {{$data->category_name}}</a></li>
           <?php } ?>
            </ul>
				</div>
                ...
                <div class="mitem3">
                    <div class="sr-card">
                      <h5 class="sr-title1 d-flex" style="color:orange;font-size:16px; font-weight:bold;">
                        <span class="back-q">Q</span> Regarding safety of self n wife</h5>
                    </div>
