		...
		<div class="row justify-content-center">
			<div class="col-md-10">
				<div class="row figure-row">
					<div class="col-md-4">
						<h4>45</h4>
						<p>8 Figure settlements</p>
					</div>
					<div class="col-md-4">
						<h4>100%</h4>
						<p>Excellence in results</p>
					</div>
					<div class="col-md-4">
						<h4>125</h4>
						<p>Ongoing trials</p>
...
<section class="why-legal-buddy">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col1">
				<img src="{{asset('fronted/images/Rectangle152.png')}}">
			</div>
			<div class="col-md-6 col2">
				<div class="title">
...
<section class="management">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="team-box">
					<img class="main" src="{{asset('fronted/images/team1.png')}}">
					<div class="text">
			...
			<div class="col-md-4">
				<div class="team-box">
					<img class="main" src="{{asset('fronted/images/team2.png')}}">
					<div class="text">
					...
					<div class="form">
						<form>
							 <div class="form-group">
							    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email" autocomplete="off">
							  </div>
							  <div class="form-group">
							  	<div class="with-label">
								    ...
								    <select class="select2 form-control">
								    	...
								    	<option>Lorem  ipsum two</option>
								    	<option>Lorem  ipsum three</option>
								    </select>
								</div>
							  </div>
							  <div class="form-group">
