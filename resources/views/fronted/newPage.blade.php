    ...
    <div class="inner">
        <div class="container">
            <div class="sa-application">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="sa-color1 d-flex justify-content-between  res-lq-font">How to Submit Post at Legal Bench</h2>
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <ol>
                                                ...
                                                <li><strong>Body</strong> of the Email Shall Contain: <ol>
                                                        ...
                                                        <li><strong>Undertaking</strong> in Case of Articles other than Press Release: That the task submitted is an original piece of work and is not under consideration for publication anywhere else.</li>
                                                    </ol>
                                                </li>
                                                <li><strong>Attachment:</strong> Only word file and Original Picture/Poster.</li>
                                            </ol>
                                            <blockquote>
                                            ...
                                            <ol>
                                                ...
                                                <li>Use short sentences and small paragraphs.</li>
                                                <li>Use headings and subheadings to enhance readability.</li>
                                            ...
                                            <ol>
                                                ...
                                                <li>Use short sentences and small paragraphs.</li>
                                                <li>Use headings and subheadings to enhance readability.</li>
                                                <li>Add an attachment/banner of size 800/500 px in png or jpg.</li>
                                            </ol>
                                            <p style="text-align: justify;">We hope you found this useful. Support us by Sharing Your Knowledge or any information. Every contribution toward a goal is valuable, regardless of how small it may be.</p>
