		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-6 col2">
					<div class="top">
						<div class="inner">
							...
							<div class="form">
								...
								<form id="main_id" method="POST" action="<?php echo URL::to('/')?>/customerverify-email" >
									@csrf
								    ...
								    <div class="form-group mb-3 text-right">
								    	<a href="<?php echo URL::to('/') ?>/customer/login" class="forgot-password">Back to login?</a>
								    </div>
					...
					<div class="bottom">
						<a href="<?php echo URL::to('/') ?>/customer/register">I Need to Signup</a>
					</div>
				</div>
			</div>
		</div>
