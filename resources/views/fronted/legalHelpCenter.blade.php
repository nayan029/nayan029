...
<div class="sa-enroll-details">
      <div class="container">
        ...
        <div class="sa-application">
            <h5 class="sa-color2 mb-4">LEGAL HELP CENTER</h5>
        </div>
		 </div>
        <div class="row">
          <div class="col-md-7 ">
                ...
                <div class="mitem3">
                    <div class="sr-card">
                      <a href="#" class="color2 text-right"><h5 class="sr-title1 d-flex "> Family Law &nbsp; &nbsp; >> </h5></a>
						...
						Divorce laws in India are full of complexities and there is no uniform code for divorce which makes it difficult to obtain divorce. This help centre will guide you through the various aspects of divorce in the country and related matters like maintenance, division of property , restitution of Conjugal rights, property issues, child custody etc.
						
						<a href="#" class="color2 text-right"><h6 class="d-flex mt-5 "> Dowry Law Help Center &nbsp; &nbsp; >> </h6></a>
